    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="delAgree btn btn-primary">${manager.enabled == false ? "등록" :" 삭제" }
                </button>
            </div>
        </div>
    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form>
                            ...
                            <button type="submit"
                                    class="delBtn btn btn-${manager.enabled == false ? 'primary' : 'danger' } btn-round pull-right">
                                ${manager.enabled == false ? "등록" : "삭제" }
                            </button>
                            <button type="submit"
                                    class="modBtn btn btn-primary btn-round pull-right">수정
                            </button>
