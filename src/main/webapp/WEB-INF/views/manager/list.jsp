                ...
                <div class="card">
                    <div class="cardHeaderStyle card-header card-header-primary">
                        ...
                        <div class="cardHeaderBtn">
                            <button type="submit" class="delListBtn btn btn-primary pull-right"
                                    style="background-color: #ffffff; color: #ee6d09;">Del List
                            </button>
                            <button type="submit" class="appListBtn btn btn-primary pull-right"
                                    style="background-color: #ffffff; color: #ee6d09;">App List
                            </button>
                        </div>
                    </div>
                        ...
                        <div class="listTop">
                            ...
                            <div class="selectType">
                                <select class="selectTypeVal custom-select">
                                    <option ${
                                    "m" == pageDTO.type ? "selected" : "" } value="m">ID</option>
                                    <option ${
                                    "s" == pageDTO.type ? "selected" : "" } value="s">email</option>
                                    <option ${
                                    "c" == pageDTO.type ? "selected" : "" } value="c">phone</option>
                                </select>
                            </div>
                            ...
                            <div class="selectPerSheet">
                                <select class="selectPerSheet custom-select">
                                    <option ${10== pageDTO.perSheet ?
                                    "selected" : "" } value="10">10개씩</option>
                                    <option ${20== pageDTO.perSheet ?
                                    "selected" : "" } value="20">20개씩</option>
                                    <option ${30== pageDTO.perSheet ?
                                    "selected" : "" } value="30">30개씩</option>
                                </select>
                            </div>
                        </div>
                        <div class="table-responsive">
                            ...
                            <div style="display: flex; flex-direction: column;">
                                <div class="cardBottomBtn">
                                    <button type="submit"
                                            class="registerBtn btn btn-primary pull-right">Register
                                    </button>
                                </div>
