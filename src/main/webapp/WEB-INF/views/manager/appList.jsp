                ...
                <div class="card">
                    <div class="cardHeaderStyle card-header card-header-primary">
                        ...
                        <div class="cardHeaderBtn">
                            <button type="submit" class="allListBtn btn btn-primary pull-right"
                                    style="background-color: #ffffff; color: #ee6d09;">List
                            </button>
                        </div>
                    </div>
                    <div class="card-body">
...
<form class="actionForm" action="/admin/manager/appList" method="get">
