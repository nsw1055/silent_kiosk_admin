                    ...
                    <div class="card-body">
                        <div class="listTop">
                            ...
                            <div class="searchList input-group no-border">
                                <input name="skeyword"
                                       type="text" value="${pageDTO.keyword}" class="searchValue form-control"
                                       placeholder="Search...">
                            ...
                            <table class="table">
                                ...
                                <c:forEach items="${topList }" var="top">
                                    <tr data-nno="${top.nno }" style="background-color: #f2f2f2;">
                                        ...
                                        <td>${top.category}</td>
                                        <td data-nno="${top.nno}">
                                            <c:if test="${top.img}"><img src="/admin/common/notice/thumb?nno=${top.nno}"
                                                                         style="width: 100px; height: 50px; object-fit: cover;">
                                            </c:if>
                                        </td>
                                        <td><STRONG data-nno="${top.nno}"><b>${top.title}</b></STRONG>
                                            <c:if test="${top.file}">&nbsp;<i class="fas fa-paperclip"></i></c:if>
                                        </td>
                                        <td>${top.writer }</td>
                                        ...
                                        <fmt:parseNumber value="${top.updatedate.time}" var="update"
                                                         integerOnly="true"/>
                                ...
                                <c:forEach items="${list}" var="notice">
                                    <tr data-nno="${notice.nno }">
                                        ...
                                        <td data-nno="${notice.nno }">
                                            <c:if test="${notice.img}"><img
                                                    src="/admin/common/notice/thumb?nno=${notice.nno}"
                                                    style="width: 100px; height: 50px; object-fit: cover;"></c:if>
                                        </td>
                                        <td>${notice.title}
                                            <c:if test="${notice.file}">&nbsp;<i class="fas fa-paperclip"></i></c:if>
                                        </td>
                                        <td>${notice.writer }</td>
                                        <fmt:parseNumber value="${notice.regdate.time}" var="nreg" integerOnly="true"/>
                                        <fmt:parseNumber value="${notice.updatedate.time}" var="nupdate"
                                                         integerOnly="true"/>
                        ...
                        <div>
                            <ul class="pagination justify-content-center">
                                <c:if test="${pageMaker.prev }">
                                    <li class="page-item"><a class="page-link" href="${pageMaker.start-1 }" tabindex="-1" aria-disabled="true">Previous</a></li>
                                </c:if>
                                <c:forEach begin="${pageMaker.start}" end="${pageMaker.end }" var="num">
                                    <li class="page-item ${pageDTO.page == num? "active" : ""} "><a class="page-link" href="${num }">${num }</a></li>
                                </c:forEach>
