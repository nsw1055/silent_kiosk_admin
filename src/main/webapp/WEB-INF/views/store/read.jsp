                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form>
                            ...
                            <a href="/admin/store/register?mid=${manager.mid }"
                               class="btn btn-primary btn-round">매장등록</a>
                ...
                <div class="col-md-8">
                    <div class="card card-profile">
                        ...
                        <div class="card-body" style="text-align: left;">
                            ...
                            <a href="/admin/store/menuList?mid=${store.mid}&sno=${store.sno }&cno=1" class="btn btn-primary btn-round">메뉴관리</a>
                            <a href="/admin/store/modify?mid=${store.mid }&sno=${store.sno}"
                               class="btn btn-primary btn-round">수정</a>
...
<script>
    ...
    document.querySelector(".modCommit").addEventListener("click", function (e) {
        ...
        service.sendRegister(managerDTO, path, csrfTokenValue).then(result => {
