                        ...
                        <div class="card-header card-header-warning card-header-icon">
                            ...
                            <div class="form-group">
                                <label class="bmd-label-floating"></label> <input type="text"
                                                                                  ...
                                                                                  value="" placeholder="토핑이름">
                            </div>
                            <div class="form-group">
                                <label class="bmd-label-floating"></label> <input type="text"
                                                                                  class="form-control" name='tprice'
                                                                                  value="" placeholder="가격">
                            </div>
                            <div class="form-group">

                            </div>
                            <div style="margin-bottom: 10px">
                                <input type="file" name="timg" data-fileName="" class="form-control"
                                       id="inputGroupFile02">
                            </div>
                        </div>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <div class="menuInfo card card-stats">
                                        <div class="card-header card-header-warning card-header-icon">
                                            <div class="card-icon imgDiv ">
                                                <img class="menu-img"
                                                     src="/admin/common/topping/view?link=<%=sno %>/${topping.tno }/${topping.timg}"/>
                                            </div>
                                        ...
                                        <div class="card-footer">
                                            <div class="menuBtn stats" data-mno="${topping.tno }">
                                                <button type="submit"
                                                        ...
                                                        style="padding: 5px;" value="/admin/store/toppingModify">수정
                                                </button>
                                                <button type="submit"
                                    ...
                                    <div class="card-footer">
                                        <div class="stats">
                                            <button type="submit"
                                                    ...
                                                    style="" value="/admin/store/toppingRegister">등록
                                            </button>
                                        </div>
                                    </div>
                                </div>
